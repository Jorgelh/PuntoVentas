...
public class Opcion2 extends javax.swing.JPanel {
   int pan= 1;
   int marca3 =1; int marca15=0;
   int marca4 =1; int marca16=0;
   int marca5 =1; int marca17=0;
   int marca6 =1; int marca18=0;
   int marca7 =1; int marca19=0;
   int marca8 =1; int marca20=0;
   int marca9 =1; int marca21=0;
   int marca10 =1; int marca22=0;
   int marca11 =1; int marca23=0;
   int marca12 =1; int marca24=0;
   int marca13 =1;int marca25=0;
   int marca14 =1;int marca26=0;
   int marca27=0;
   int marca28=0;
   int marca29=0;
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                        ...
                        .addGroup(javax.swing.GroupLayout.Alignment.LEADING, layout.createSequentialGroup()
                            ...
                            .addGap(141, 141, 141))
                        .addComponent(jPanel1, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.PREFERRED_SIZE, 694, javax.swing.GroupLayout.PREFERRED_SIZE)))
                .addContainerGap())
        );
    ...
    private void Extra1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_Extra1MouseClicked
        if(marca15==0 ){Botton15.setBackground(Color.GREEN);marca15=1;}else{Botton15.setBackground(Color.red);marca15=0;}
    ...
    private void Extra2MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_Extra2MouseClicked
        if(marca16==0 ){Botton16.setBackground(Color.GREEN);marca16=1;}else{Botton16.setBackground(Color.red);marca16=0;}
    ...
    private void Extra3MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_Extra3MouseClicked
        if(marca17==0 ){Botton17.setBackground(Color.GREEN);marca17=1;}else{Botton17.setBackground(Color.red);marca17=0;}
    ...
    private void Extra4MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_Extra4MouseClicked
        if(marca18==0 ){Botton18.setBackground(Color.GREEN);marca18=1;}else{Botton18.setBackground(Color.red);marca18=0;}
    ...
    private void Extra5MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_Extra5MouseClicked
        if(marca19==0 ){Botton19.setBackground(Color.GREEN);marca19=1;}else{Botton19.setBackground(Color.red);marca19=0;}
    ...
    private void Extra6MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_Extra6MouseClicked
        if(marca20==0 ){Botton20.setBackground(Color.GREEN);marca20=1;}else{Botton20.setBackground(Color.red);marca20=0;}
    ...
    private void Extra7MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_Extra7MouseClicked
        if(marca21==0 ){Botton21.setBackground(Color.GREEN);marca21=1;}else{Botton21.setBackground(Color.red);marca21=0;}
    ...
    private void Extra8MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_Extra8MouseClicked
        if(marca22==0 ){Botton22.setBackground(Color.GREEN);marca22=1;}else{Botton22.setBackground(Color.red);marca22=0;}
    ...
    private void Extra9MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_Extra9MouseClicked
        if(marca23==0 ){Botton23.setBackground(Color.GREEN);marca23=1;}else{Botton23.setBackground(Color.red);marca23=0;}
    ...
    private void Extra11MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_Extra11MouseClicked
        if(marca25==0 ){Botton25.setBackground(Color.GREEN);marca25=1;}else{Botton25.setBackground(Color.red);marca25=0;}
    ...
    private void Extra13MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_Extra13MouseClicked
        if(marca27==0 ){Botton27.setBackground(Color.GREEN);marca27=1;}else{Botton27.setBackground(Color.red);marca27=0;}
    ...
    private void Extra14MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_Extra14MouseClicked
        if(marca28==0 ){Botton28.setBackground(Color.GREEN);marca28=1;}else{Botton28.setBackground(Color.red);marca28=0;}
    ...
    private void QuesoMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_QuesoMouseClicked
        if(marca29==0 ){Botton29.setBackground(Color.GREEN);marca29=1;}else{Botton29.setBackground(Color.red);marca29=0;}
    ...
    private void Extra10MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_Extra10MouseClicked
        if(marca24==0 ){Botton24.setBackground(Color.GREEN);marca24=1;}else{Botton24.setBackground(Color.red);marca24=0;}
    ...
    private void Extra12MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_Extra12MouseClicked
        if(marca26==0){Botton26.setBackground(Color.GREEN);marca26=1;}else{Botton26.setBackground(Color.red);marca26=0;}
