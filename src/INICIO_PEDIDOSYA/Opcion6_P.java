 ...
 * @author jluis
 */
public class Opcion6_P extends javax.swing.JPanel {
    ...
    public Opcion6_P(int a) {
        ...
        VEITITRES.setText(texto22);
         String texto23 = "<html><center><body>CHOCOLATE 16 ONZ</body></center></html>";
   ...
   /* private void Limpiar() {
    ...
    private void validagratis1() {
        
            try {
                 BDConexion conecta = new BDConexion();
                Connection cn = conecta.getConexion();
                java.sql.Statement stmt = cn.createStatement();
                ResultSet rs = stmt.executeQuery("SELECT sum(CANTIDAD) FROM elrey.productos_pedido  where ID_PRODUCTO in(13,14,15,16,17,19,20,21,22,23,24) and id_pedido =" + id_pedido);
                while (rs.next()) {
                    gratis1 = rs.getInt(1);
                }
                rs.close();
    ...
    private void validagratis2() {
        
            try {
                 BDConexion conecta = new BDConexion();
                Connection cn = conecta.getConexion();
                java.sql.Statement stmt = cn.createStatement();
                ResultSet rs = stmt.executeQuery("SELECT sum(CANTIDAD) FROM elrey.productos_pedido  where ID_PRODUCTO in(4,6,7,8,9,10,12,18) and id_pedido =" + id_pedido);
                while (rs.next()) {
                    gratis2 = rs.getInt(1);
                }
                rs.close();
   ...
   // Limpiar();
    ...
    private void initComponents() {
        ...
        VEITITRES.setText("CHOCOLATE 8 ONZ");
        ...
        B31.setPreferredSize(new java.awt.Dimension(145, 45));
        B31.setRoundBottomLeft(15);
        B31.setRoundBottomRight(15);
        B31.setRoundTopLeft(15);
        B31.setRoundTopRight(15);
        ...
        B32.setPreferredSize(new java.awt.Dimension(145, 45));
        B32.setRoundBottomLeft(15);
        B32.setRoundBottomRight(15);
        B32.setRoundTopLeft(15);
        B32.setRoundTopRight(15);
        ...
        B28.setPreferredSize(new java.awt.Dimension(145, 45));
        B28.setRoundBottomLeft(15);
        B28.setRoundBottomRight(15);
        B28.setRoundTopLeft(15);
        B28.setRoundTopRight(15);
        ...
        VEINTIOCHO.setFont(new java.awt.Font("Arial", 1, 10)); // NOI18N
        VEINTIOCHO.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        VEINTIOCHO.setText("CHOCOLATE 16 ONZ");
        VEINTIOCHO.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                VEINTIOCHOMouseClicked(evt);
            }
            public void mouseEntered(java.awt.event.MouseEvent evt) {
                VEINTIOCHOMouseEntered(evt);
            }
        });
        ...
        B28Layout.setHorizontalGroup(
            ...
            .addComponent(VEINTIOCHO, javax.swing.GroupLayout.DEFAULT_SIZE, 145, Short.MAX_VALUE)
        );
 ...
 if ((evt.getModifiers() & 4) != 0) {
    ...
    private void VEINTINUEVE2MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_VEINTINUEVE2MouseClicked
     /*   if(gratis1 >= 1 || gratis2 >= 2){
        if ((evt.getModifiers() & 4) != 0) {
            ...
            B31.setBackground(Color.darkGray);
            timer.setRepeats(false);
            timer.start();
        } else {
            id_producto = 77;
    ...
    private void VEINTINUEVE3MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_VEINTINUEVE3MouseClicked
        if ((evt.getModifiers() & 4) != 0) {
            ...
            B32.setBackground(Color.darkGray);
            timer.setRepeats(false);
            timer.start();
        } else {
            id_producto = 81;
    ...
    private void VEINTIOCHOMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_VEINTIOCHOMouseClicked
        if ((evt.getModifiers() & 4) != 0) {
            id_producto = 31;
            id_nota = 40;
            BuscarExistencia();
            ...
            B28.setBackground(Color.darkGray);
            timer.setRepeats(false);
            timer.start();
        } else {
            id_producto = 31;
    ...
    }//GEN-LAST:event_VEINTIOCHOMouseClicked

    private void VEINTIOCHOMouseEntered(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_VEINTIOCHOMouseEntered
        // TODO add your handling code here:
    }//GEN-LAST:event_VEINTIOCHOMouseEntered
