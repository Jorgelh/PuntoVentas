...
public class Reimprimir extends javax.swing.JFrame {
      ...
      public void sumaTotalVenta() {
        ...
        DecimalFormat df = new DecimalFormat("#.00");
            try {
                ...
                Connection cn = conecta.getConexion();
                java.sql.Statement stmt = cn.createStatement();
                ResultSet rs = stmt.executeQuery("SELECT SUM(TOTAL) AS TOTAL FROM pedidos where date_format(fecha,'%d/%m/%Y') = '"+fechaT+"'");
                while (rs.next()) {
                    String TOTAL = df.format(rs.getInt(1));
    ...
    private void initComponents() {
        ...
        TotalVenta.setFont(new java.awt.Font("Arial", 1, 12)); // NOI18N
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel2Layout.createSequentialGroup()
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel2Layout.createSequentialGroup()
                        ...
                        .addComponent(TotalVenta, javax.swing.GroupLayout.PREFERRED_SIZE, 110, javax.swing.GroupLayout.PREFERRED_SIZE))
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel2Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                    ...
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            .addComponent(FECHA, javax.swing.GroupLayout.DEFAULT_SIZE, 247, Short.MAX_VALUE)
